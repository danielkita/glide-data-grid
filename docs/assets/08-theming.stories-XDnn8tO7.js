import{r as e}from"./iframe-8phuShmr.js";import{G as b}from"./image-window-loader-IO2VdSpy.js";import{D as d}from"./data-editor-all-h1dS7s2L.js";import{S as F}from"./story-utils-_tnAyFDH.js";import{D as v,M as g,H as c,W as s}from"./doc-wrapper-jcLD_Q7c.js";import"./throttle-Hjf6IrDY.js";import"./marked.esm-o-qZb0sR.js";import"./flatten-m03yMbtg.js";import"./scrolling-data-grid-u8-nOOtL.js";import"./toConsumableArray-ppDpjNRJ.js";const A={title:"Glide-Data-Grid/Docs",decorators:[t=>e.createElement(F,null,e.createElement(t,null))]},n=[{name:"Deidre Morris",company:"GONKLE",email:"deidremorris@gonkle.com",phone:"+1 (867) 507-3332"},{name:"Sheryl Craig",company:"EVENTAGE",email:"sherylcraig@eventage.com",phone:"+1 (869) 520-2227"},{name:"Lidia Bowers",company:"ANOCHA",email:"lidiabowers@anocha.com",phone:"+1 (808) 414-3826"},{name:"Jones Norton",company:"REPETWIRE",email:"jonesnorton@repetwire.com",phone:"+1 (875) 582-3320"},{name:"Lula Bruce",company:"COMDOM",email:"lulabruce@comdom.com",phone:"+1 (873) 452-2472"},{name:"Larsen Montgomery",company:"SQUISH",email:"larsenmontgomery@squish.com",phone:"+1 (893) 482-3651"},{name:"Becky Bright",company:"COMCUR",email:"beckybright@comcur.com",phone:"+1 (879) 494-2331"},{name:"Charlotte Rowland",company:"FROLIX",email:"charlotterowland@frolix.com",phone:"+1 (861) 439-2134"},{name:"Sonya Hensley",company:"GEEKETRON",email:"sonyahensley@geeketron.com",phone:"+1 (802) 553-2194"},{name:"Stephenson Guthrie",company:"EXOSWITCH",email:"stephensonguthrie@exoswitch.com",phone:"+1 (903) 449-3271"},{name:"Mcmillan Cline",company:"TURNLING",email:"mcmillancline@turnling.com",phone:"+1 (982) 496-2454"},{name:"Kemp Davis",company:"TETRATREX",email:"kempdavis@tetratrex.com",phone:"+1 (859) 594-2982"},{name:"Matilda Levy",company:"SLOFAST",email:"matildalevy@slofast.com",phone:"+1 (841) 521-2444"},{name:"Hattie Simpson",company:"COMTRAK",email:"hattiesimpson@comtrak.com",phone:"+1 (962) 587-3805"},{name:"Kinney Munoz",company:"IDETICA",email:"kinneymunoz@idetica.com",phone:"+1 (921) 513-2012"},{name:"Lambert Raymond",company:"TURNABOUT",email:"lambertraymond@turnabout.com",phone:"+1 (919) 519-2442"},{name:"Bryant Dunlap",company:"BYTREX",email:"bryantdunlap@bytrex.com",phone:"+1 (872) 583-2883"}],l=()=>{const t=e.useCallback(o=>{const[a,i]=o,r=n[i][["name","company","email","phone"][a]];return{kind:b.Text,allowOverlay:!0,displayData:r,data:r}},[]),C=e.useCallback(o=>{const[a,i]=o,r=n[i][["name","company","email","phone"][a]];let u;return a===1&&i===1&&(u={textDark:"#FF0000"}),{kind:b.Text,allowOverlay:!0,displayData:r,data:r,themeOverride:u}},[]),m=e.useCallback(o=>{if(o%2===0)return{bgCell:"#F9FDFF"}},[]),T=e.useMemo(()=>[{title:"Name",id:"name"},{title:"Company",id:"company"},{title:"Email",id:"email"},{title:"Phone",id:"phone"}],[]),h=e.useMemo(()=>[{title:"Name",id:"name"},{title:"Company",themeOverride:{textDark:"#225588",baseFontStyle:"600 13px"},id:"company"},{title:"Email",id:"email"},{title:"Phone",id:"phone"}],[]);return e.createElement(v,null,e.createElement(g,null,`
# Theming
...
`),e.createElement(s,{height:200},e.createElement(d,{theme:{bgCell:"#F2F9FF"},getCellContent:t,columns:h,rows:n.length})),e.createElement(g,null,"### Row themes"),e.createElement(c,null,`
...
`),e.createElement(s,{height:200},e.createElement(d,{theme:{bgCell:"#F2F9FF"},getRowThemeOverride:m,getCellContent:t,columns:h,rows:n.length})),e.createElement(g,null,"### Cell themes"),e.createElement(c,null,`
...
`),e.createElement(s,{height:200},e.createElement(d,{theme:{bgCell:"#F2F9FF"},getRowThemeOverride:m,getCellContent:C,columns:h,rows:n.length})))};l.storyName="08. Theming";var p,f,y;l.parameters={...l.parameters,docs:{...(p=l.parameters)==null?void 0:p.docs,source:{originalSource:`() => {
  const getContent = React.useCallback((cell: Item): GridCell => {
    const [col, row] = cell;

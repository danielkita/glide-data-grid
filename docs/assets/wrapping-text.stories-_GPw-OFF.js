import{R as e}from"./iframe-8phuShmr.js";import{D as f}from"./data-editor-all-h1dS7s2L.js";import{B as d,D as C,P as h,u as x,d as w}from"./utils-VUy4fYQZ.js";import{G as y}from"./image-window-loader-IO2VdSpy.js";import{S as W}from"./story-utils-_tnAyFDH.js";import{r as D}from"./throttle-Hjf6IrDY.js";import{y as E}from"./index-PWBWJyi_.js";import"./flatten-m03yMbtg.js";import"./scrolling-data-grid-u8-nOOtL.js";import"./marked.esm-o-qZb0sR.js";import"./index.esm-kO0Sgbx2.js";import"./index-cCyqJzv7.js";const S={title:"Glide-Data-Grid/DataEditor Demos",decorators:[t=>e.createElement(W,null,e.createElement(d,{title:"Wrapping Text",description:e.createElement(C,null,"Text cells can have wrapping text by setting the ",e.createElement(h,null,"allowWrapping")," prop to true.")},e.createElement(t,null)))]},n=t=>{const{cols:m,getCellContent:l,onColumnResize:c}=x(6),r=e.useMemo(()=>D(0,100).map(()=>E.lorem.sentence(t.length)),[t.length]),g=e.useCallback(o=>{const[u,a]=o;return u===0?{kind:y.Text,allowOverlay:!0,displayData:`${a},
${r[a%r.length]}`,data:`${a}, 
